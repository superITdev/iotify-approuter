<template>
     <div id="canvas" class="jtk-demo-canvas canvas-wide flowchart-demo jtk-surface jtk-surface-nopan" @dragover.prevent @drop.prevent="drop">
        <div id="flowchartWindow1" class="window jtk-node">
          <img src="/assets/img/work/group1.png" alt="flowchartWindow1"/>
        </div>        
        <div id="flowchartWindow2" class="window jtk-node">
          <img src="/assets/img/work/group2.png" alt="flowchartWindow2"/>
        </div>
        <div id="flowchartWindow3" class="window jtk-node">
          <img src="/assets/img/work/group3.png" alt="flowchartWindow3" style="width: 135px"/>
        </div>
      </div>
</template>
  ...
  mounted () {
    JSPlumb.ready(function() {
      ...
      instance.batch(function () {
        ...
        // instance.connect({uuids: ["Window2LeftMiddle", "Window1LeftMiddle"]});
