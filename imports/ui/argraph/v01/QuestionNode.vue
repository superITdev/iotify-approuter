<template>
    <div v-bind:style="{left:obj.left + 'px', top:obj.top + 'px', width:obj.w + 'px', height:obj.h + 'px'}" class="flowchart-object flowchart-question">
...
<script>
    import BaseEditableNode from '/imports/ui/argraph/v01/BaseEditableNode.vue'
    export default {
